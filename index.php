...
<body>
    <nav>
        <ul>
            ...
            <li><button id="signin"
                    style="color:#be06e3; width:80px; height:28px; border-radius: 18px; background-color: #ffffff;"
                    class="signup mt-1">Sign Up</button></li>
            <li><button id="login"
                    style="color:#be06e3; width:80px; height:28px; border-radius: 18px; background-color: #ffffff;"
                    class="login mt-1">Log in</button></li>
            <li>
                <center>
        ...
        <div class="group">
            ...
            <a href="cart.php">
                <?php
                  ...
                  ?>
                <i class="fa" style="margin-left:20px; background:transparent; color:white;font-size:24px">&#xf07a;</i>
    ...
    <div class="slideshow-container">
        <div class="mySlides fade">
            <img src="banner.jpg" style="width:100%"  height="500px">
        </div>

        <div class="mySlides fade">
            <img src="banner2.jpg" style="width:100%"  height="500px">
        </div>

        <div class="mySlides fade">
            <img src="banner3.jpg" style="width:100%"  height="500px">
        </div>
    </div>
    <br>
    ...
    <center>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card mt-2 mb-2" style="width: 20rem;">
                        <a href="cat1.php?cat=<?php echo $cat ?>">
                            <img class="card-img-top" src="categorieimg/<?php echo $row['photo']?>" alt="Card image cap"
                                height="350"></a>
                        <div class="card-body">
                            <a href="cat1.php?cat=<?php echo $cat ?>">
                                <h2 class="card-text"><?php echo $row['categorie']?></h2>
                            </a>
                            <a href="cat1.php?cat=<?php echo $cat ?>">
                                <h3 class="card-text"><?php echo $row['discount']?>% Discount</h3>
                            </a>
                            <a href="cat1.php?cat=<?php echo $cat ?>"><button
                                    style="width:auto"><?php echo $row['trending']?></button></a>
                        </div>
                    </div>
                </div>
                <?php
        ...
        <hr>
        <div style="width:100%; height:350px; background-color:blue; color: #ffffff;">
            <h4 id="contactus"> Contact Us</h4>
            <h1 style="align:center; color:white;">This is Only a Demo Website Any Items Is Not purchasable</h1>
        </div>
        <div class="popup">
            ...
            <div class="form">
                ...
                <form method="post" action="login.php">
                    <div class="form-element">
                        ...
                        <input type="email" name="email" id="email" value="<?php if(isset($_COOKIE['emailcookie']))
                        { echo $_COOKIE['emailcookie'];} ?>" class="form-control" required
                            placeholder="Enter Email">
                    </div>
                    <div class="form-element">
                        <label for="password">Password</label>
                        <input type="password" name="pass" id="password" value="<?php if(isset($_COOKIE['passcookie']))
                        { echo $_COOKIE['passcookie'];} ?>" class="form-control" required
                            placeholder="Enter Password">
                    </div>
                    <div class="form-element">
                        <label for="remember-me">remember-me</label>
                        <input type="checkbox" name="rm" id="remember-me" placeholder="Enter Password">
                    </div>
                    <div class="form-element">
            ...
            <div class="popup2">
                ...
                <div class="form2">
                    ...
                    <div class="form-element2">
                        ...
                        <input type="file" name="photo" id="ppho" class="form-control" required
                            placeholder="Upload |Profile Photo">
                    </div>
                    <div class="form-element2">
                        <label for="fnm">First Name:</label>
                        <input type="text" name="fnm" id="fnm" class="form-control" required
                            placeholder="Enter First Name">
                    </div>
                    <div class="form-element2">
                        <label for="lnm">Last Name:</label>
                        <input type="text" name="lnm" id="lnm" class="form-control" required
                    ...
                    <div class="form-element2">
                        ...
                        <input type="password" name="cpass" minlength="8" maxlength="20" id="txtPassword"
                            class="form-control" style="user-select:none;" required placeholder="Create Password">
                    </div>
                    <div class="form-element2">
                        <label for="conpassword">Confirm Password:</label>
                        <input type="password" minlength="8" maxlength="20" name="conpass" id="txtConfirmPassword"
                            class="form-control" style="user-select:none;" required placeholder="Confirm Password">
                    </div>
                    <div class="form-element2">
