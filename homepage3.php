<script>alert('signup succesfully please login to continue')</script>
<!DOCTYPE html>
<html lang="en">
    ...
    <header style="width:100%">
        ...
        <div class="group">
            ...
            <a href="cart.php">
                ...
                ?>
                <i class="fa" style="color:white;font-size:24px">&#xf07a;</i>
                ...
                <div class="col-md-4">
                    <div class="card mt-2 mb-2" style="width: 20rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="cat1.php">
                                <center><button style="width:auto">
                                        <?php echo $row['trending'] ?>
                                    </button></center>
                            </a>
                        </div>
                    </div>
        ...
        <div class="form">
            ...
            <form method="post" action="login.php">
                <div class="form-element">
                    ...
                    <input type="email" name="email" id="email" class="form-control" value="<?php if(isset($_COOKIE['emailcookie']))
                        { echo $_COOKIE['emailcookie'];} ?>" required placeholder="Enter Email">
                </div>
                <div class="form-element">
                    <label for="password">Password</label>
                    <input type="password" name="pass" value="<?php if(isset($_COOKIE['passcookie']))
                        { echo $_COOKIE['passcookie'];} ?>" id="password" class="form-control" required
