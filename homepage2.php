...
<body>
    <nav>
        <ul>
            ...
            <li class="lg mt-1"><img src="Beauty Studio.jpg" alt="" height="30" width="100" class="logonav"></li>
            <li>
                <center>
                    <form action="search.php">
                        <div class="input-group ps-5">
                            <div id="navbar-search-autocomplete" class="form-outline">
                                <input type="search" name="search" id="form1" style="width:50vh" class="form-control sea" placeholder="Search Products..." />
                            </div>
    ...
    <header style="width:100%">
        <h1 class="mt-2" style="color:white; font-weight:bolder;">Hii  <?php echo $row['fnm'] ?> </h1><?php } ?>
        <div class="group">
            <ul class="navigation">
                <li><a href="#">Home</a></li>
            ...
            <ion-icon id="signin" class="person p-2" name="person-circle-outline"
                style="cursor:pointer; margin-bottom: 12px;  color:#ffffff; width: 30px;; height:25px;"></ion-icon>
            <a href="cart.php">
                <?php
                  require "dbcon.php";
            ...
            <div class="popup">
                ...
                <div class="form">
                    ...
                    <div class="form-element">
                        <img src="profile/<?php echo $row['profile_photo'] ?>"
                            style="border-radius:50%; border:5px solid blue" height="80" width="80">
                    </div>
                    <div class="form-element">
                    ...
                    <div class="form-element">
                        ...
                        <a href="proupdate.php?id=<?php echo $id ?>">Update</a>
                    </div>
                </div>
            </div>
            <?php
